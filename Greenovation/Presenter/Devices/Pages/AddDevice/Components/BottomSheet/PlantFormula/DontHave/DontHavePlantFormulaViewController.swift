...
//            from: String(localized: "Rekomendasi yang diberikan Greenovation untuk \(plantName) pada \(growthStep) adalah Kepekatan Nutrisi: \(ppm)ppm dan Tingkat pH: \(ph)"),
//            boldStrings: ["Greenovation", plantName, growthStep, "Kepekatan Nutrisi: \(ppm)ppm", "Nutrient Concentration: \(ppm)ppm", "Tingkat pH: \(ph)", "pH Level: \(ph)"],
